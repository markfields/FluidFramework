...
export class FluidSerializer implements IFluidSerializer {
	 ...
	 * @param handleDecodedCb - called whenever a handle is decoded/parsed by this serializer.
	 * @param handleEncodedCb - called whenever a handle is encoded/serialized by this serializer.
	 */
	public constructor(
		private readonly context: IFluidHandleContext,
		private readonly handleDecodedCb: (handle: IFluidHandle) => void = () => {},
		private readonly handleEncodedCb: (handle: IFluidHandle) => void = () => {},
	) {
	...
	public stringify(input: any, bind: IFluidHandle) {
		...
		//* s/b handleS Encoded - actually s/b part of the return value
		this.handleEncodedCb(handles as any);
		return string;
	}
	...
	private readonly decodeValue = (value: any) => {
		...
		if (isSerializedHandle(value)) {
			...
			this.handleDecodedCb(parsedHandle);
			return parsedHandle;
		} else {
			return value;
		}
